...
class TFCarousel_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'TF Carousel', 'tfcarousel-box-addon-for-elementor' );
    }
	...
	protected function _register_controls() {
		...
		$this->start_controls_section( 
			'section_carousel',
            [
                'label' => esc_html__('Carousel', 'tfcarousel-box-addon-for-elementor'),
            ]
        );	    
		...
		$repeater->add_control( 
			'list_content_type',
			[
				'label' => esc_html__( 'Content type', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'content',
				'options' => [
					'content'  => esc_html__( 'Content', 'tfcarousel-box-addon-for-elementor' ),
					'template' => esc_html__( 'Template', 'tfcarousel-box-addon-for-elementor' ),
				],
			]
		);
		...
		$repeater->add_control(
			'image',
			[
				'label' => __( 'Choose Image', 'tfcarousel-box-addon-for-elementor' ),
		...
		$repeater->add_control( 
			...
			[
				'label' => esc_html__( 'Template', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->start_controls_section( 
			'section_setting',
            [
                'label' => esc_html__('Setting', 'tfcarousel-box-addon-for-elementor'),
            ]
        );	
		...
		$this->add_control( 
			'carousel_loop',
			[
				'label' => esc_html__( 'Loop', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'tfcarousel-box-addon-for-elementor' ),
				'label_off' => esc_html__( 'Off', 'tfcarousel-box-addon-for-elementor' ),
				'return_value' => 'yes',
				'default' => 'yes',				
			]
		);
		...
		$this->add_control( 
			'carousel_auto',
			[
				'label' => esc_html__( 'Auto Play', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'tfcarousel-box-addon-for-elementor' ),
				'label_off' => esc_html__( 'Off', 'tfcarousel-box-addon-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'carousel_spacer',
			[
				'label' => esc_html__( 'Spacer', 'tfcarousel-box-addon-for-elementor' ),
		...
		$this->add_control( 
			...
			[
				'label' => esc_html__( 'Columns Desktop', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '2',
				'options' => [
					'1' => esc_html__( '1', 'tfcarousel-box-addon-for-elementor' ),
					'2' => esc_html__( '2', 'tfcarousel-box-addon-for-elementor' ),
					'3' => esc_html__( '3', 'tfcarousel-box-addon-for-elementor' ),
					'4' => esc_html__( '4', 'tfcarousel-box-addon-for-elementor' ),
					'5' => esc_html__( '5', 'tfcarousel-box-addon-for-elementor' ),
					'6' => esc_html__( '6', 'tfcarousel-box-addon-for-elementor' ),
				],				
			]
		);
		...
		$this->add_control( 
			...
			[
				'label' => esc_html__( 'Columns Tablet', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '1',
				'options' => [
					'1' => esc_html__( '1', 'tfcarousel-box-addon-for-elementor' ),
		...
		$this->add_control( 
			...
			[
				'label' => esc_html__( 'Columns Mobile', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '1',
				'options' => [
					'1' => esc_html__( '1', 'tfcarousel-box-addon-for-elementor' ),
		...
		$this->start_controls_section( 
			'section_arrow',
            [
                'label' => esc_html__('Arrow', 'tfcarousel-box-addon-for-elementor'),
            ]
        );
        ...
        $this->add_control( 
			...
			[
				'label' => esc_html__( 'Arrow', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'tfcarousel-box-addon-for-elementor' ),
				'label_off' => esc_html__( 'Hide', 'tfcarousel-box-addon-for-elementor' ),
				'return_value' => 'yes',
				'default' => 'yes',				
        ...
        $this->add_control( 
			'carousel_prev_icon', [
                'label' => esc_html__( 'Prev Icon', 'tfcarousel-box-addon-for-elementor' ),
    	...
    	$this->add_control( 
    		'carousel_next_icon', [
                'label' => esc_html__( 'Next Icon', 'tfcarousel-box-addon-for-elementor' ),
                'type' => \Elementor\Controls_Manager::ICON,
        ...
        $this->add_responsive_control( 
			...
			[
				'label' => esc_html__( 'Font Size', 'tfcarousel-box-addon-for-elementor' ),
		...
		$this->add_responsive_control( 
			...
			[
				'label' => esc_html__( 'Width', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control( 
			...
			[
				'label' => esc_html__( 'Height', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control( 
			...
			[
				'label' => esc_html__( 'Horizontal Position Previous', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control( 
			...
			[
				'label' => esc_html__( 'Horizontal Position Next', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control( 
			...
			[
				'label' => esc_html__( 'Vertical Position', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_tabs( 
			...
			$this->start_controls_tab( 
				...
				[
					'label' => esc_html__( 'Normal', 'tfcarousel-box-addon-for-elementor' ),						
				]
			);
			...
			$this->add_control( 
	            ...
	            [
	                'label' => esc_html__( 'Color', 'tfcarousel-box-addon-for-elementor' ),
	        ...
	        $this->add_control( 
	            ...
	            [
	                'label' => esc_html__( 'Background Color', 'tfcarousel-box-addon-for-elementor' ),
	                'type' => \Elementor\Controls_Manager::COLOR,
	                'scheme' => [
	                    'type' => \Elementor\Scheme_Color::get_type(),
	                    'value' => \Elementor\Scheme_Color::COLOR_1,
	        ...
	        $this->add_group_control( 
				...
				[
					...
					'label' => esc_html__( 'Border', 'tfcarousel-box-addon-for-elementor' ),
			...
			$this->add_responsive_control( 
	            ...
	            [
	                'label' => esc_html__( 'Border Radius Previous', 'tfcarousel-box-addon-for-elementor' ),
	        ...
	        $this->start_controls_tab( 
				...
				[
					'label' => esc_html__( 'Hover', 'tfcarousel-box-addon-for-elementor' ),
				]
			);
		...
		$this->start_controls_section( 
			'section_bullets',
            [
                'label' => esc_html__('Bullets', 'tfcarousel-box-addon-for-elementor'),
            ]
        );
		...
		$this->add_responsive_control( 
			...
			[
				'label' => esc_html__( 'Horizonta Offset', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control( 
			...
			[
				'label' => esc_html__( 'Vertical Offset', 'tfcarousel-box-addon-for-elementor' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_tabs( 
			...
			$this->add_responsive_control( 
	            ...
	            [
	                'label' => esc_html__( 'Border Radius', 'tfcarousel-box-addon-for-elementor' ),
	                'type' => \Elementor\Controls_Manager::DIMENSIONS,
	                'size_units' => [ 'px', '%', 'em' ],
	                'selectors' => [
	        ...
	        $this->start_controls_tab( 
				...
				[
					'label' => esc_html__( 'Active', 'tfcarousel-box-addon-for-elementor' ),
				]
			);
